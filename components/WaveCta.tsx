...
export default function WaveCta() {
  ...
  return (
    <>
      ...
      <CtaWrapper>
        <Container>
          <Title>Cree y ejecute aplicaciones web dinámicas y de alto rendimiento a escala global, sin necesidad de servidores, DevOps o infraestructura costosa.</Title>
          <CustomButtonGroup>
